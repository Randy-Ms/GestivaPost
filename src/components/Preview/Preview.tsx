...
export default function Preview() {
  ...
  const renderLayer = (layer: any) => {
    ...
    const baseStyle: React.CSSProperties = {
      ...
      left: `${layer.x}px`,
      top: `${layer.y}px`,
      width: layer.width ? (String(layer.width).includes('px') ? String(layer.width) : `${layer.width}px`) : 'auto',
      height: layer.height ? (String(layer.height).includes('px') ? String(layer.height) : `${layer.height}px`) : 'auto',
